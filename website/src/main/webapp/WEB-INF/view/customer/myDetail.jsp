...
<!------------------------------------------------header ----------------------------------------------------->
	...
	<div class="body-div">
		...
		<div class="center-content">
			...
			<div class="list-div">
				<input class="btn btn-primary" type="button" onclick="location.href = '/customer/myWriting?f=${param.f}&q=${param.q}&p=${param.p }'" value="목록">
				<input class="btn btn-primary" type="button" onclick="location.href = '/customer/myNoticeUpdate?id=${param.id}&f=${param.f}&q=${param.q}&p=${param.p }'" value="수정하기">
			</div>
			<div class="prev-next-table-div">
				<table class="table">
					<tr>
				      <th class="table-active">이전글</th>
				      <td colspan="3"><a href="/customer/myDetail?id=${n_prev.id }">${n_prev.title}</a></td>
				    </tr>
				    <tr>
				      <th class="table-active">다음글</th>
				      <td colspan="3"><a href="/customer/myDetail?id=${n_next.id }">${n_next.title}</a></td>
				    </tr>
				</table>
			</div>
		</div>
