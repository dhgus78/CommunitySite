...
<!------------------------------------------------header ----------------------------------------------------->
	...
	<div class="body-div">
		...
		<form action="/customer/deleteNotice" method="post">
			...
			<div class="table-div" >
				<table class="table table-hover">
				  ...
				  <tbody>
				    ...
				    <tr>
				      <td>${n.id}</td>
				      <td colspan="2" style="font-weight: bold;"><a href="myDetail?id=${n.id}&p=${page}&f=${field}&q=${query}">${n.title}</a></td>
				      <td>${n.memberName}</td>
				      ...
				      <td><input type="checkbox"id="deleteId" name="deleteId" value="${n.id}"></td>
				    </tr>
				    </c:forEach>
				  </tbody>
			</table>
